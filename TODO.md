...
La lista está ordenada por prioridad de más alto a más bajo.

✅ Refactor de las rxResource de edit, create, register, login de todas las entidades de acuerdo a EditDeviceAreaComponent.

- EditUserComponent ok
- EditDeviceAreaComponent (base)
- EditDeviceTypecomponent ok
- EditDeviceComponent ok
- CreateDeviceAreaComponent (base)
- RegisterUserComponent ok
- CreateDeviceTypeComponent ok

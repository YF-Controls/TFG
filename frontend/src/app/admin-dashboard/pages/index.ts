...
export { DeviceAdminPage } from "./device-admin-page/device-admin-page";
export { DeviceAreaAdminPage } from "./device-area-admin-page/device-area-admin-page";
export { DeviceTypeAdminPage } from "./device-type-admin-page/device-type-admin-page";
export { UserAdminPage } from "./user-admin-page/user-admin-page";
